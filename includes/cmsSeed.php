...
function cms_seed_defaults(PDO $pdo): void
{
    ...
    $defaults = [
        'site_logo' => 'archevo-logo.png',
        'site_logo_light' => 'archevo-logo-light.png',
        'site_logo_dark' => 'archevo-logo-dark.png',
        ...
        'process_split_lead_html' => '<p class="section-lead">We structure every commission in clear phases with sign-off moments — so scope, cost, and calendar stay visible.</p>',
