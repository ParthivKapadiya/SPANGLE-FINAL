...
$pageDescription = 'Edit all sections on services.html — hero, offerings, FAQ, and more.';
$activeNav = 'services-page';
require dirname(__DIR__) . '/includes/layout.php';
?>
<div class="adm-home-hub">
  <?php foreach (cms_services_section_definitions() as $section): ?>
...
<p class="adm-hint" style="margin-top:1rem;">
  <a href="<?= e(admin_href('../services.html')) ?>" target="_blank" rel="noopener" class="adm-btn adm-btn-ghost"><i class="fa-solid fa-arrow-up-right-from-square"></i> Preview services page</a>
</p>
