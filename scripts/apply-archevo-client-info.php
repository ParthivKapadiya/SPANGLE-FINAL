...
$settings = [
    ...
    'contact_email' => 'hello@spangle.studio',
    'contact_address' => '1113, RK Supreme, Nanamava Circle, Opp. Twin Star, 150 Ft. Ring Rd, Rajkot, Gujarat',
    'whatsapp_digits' => '916359351513',
    'whatsapp_prefill' => 'Hello SPANGLE Architecture & Interior Design Studio — I would like to discuss a project.',
    ...
    'contact_page_title' => 'SPANGLE Architecture & Interior Design Studio · Rajkot',
    ...
    'services_lead' => 'At SPANGLE Architecture & Interior Design Studio, we blend structural expertise with aesthetic precision — functional, compliant, and beautifully designed spaces from brief to handover.',
    ...
    'studio_philosophy_lead_1' => 'SPANGLE Architecture & Interior Design Studio offers end-to-end services across civil engineering, plan sanctioning, interior design, and turnkey project management — one accountable team for homes, workplaces, and developments in Gujarat.',
    ...
    'studio_title' => 'SPANGLE Architecture & Interior Design Studio',
    ...
    'seo_organization_description' => 'SPANGLE Architecture & Interior Design Studio — integrated architecture, civil construction, interior design, and turnkey project management in Rajkot, Gujarat.',
    'public_website_url' => 'https://spangle.page.gd',
    ...
    'map_title' => 'SPANGLE Architecture & Interior Design Studio · RK Supreme, Nanamava Circle, Rajkot',
    'seo_home_title' => 'SPANGLE Architecture & Interior Design Studio | Architecture & Interior Design · Rajkot',
    'seo_home_description' => 'SPANGLE Architecture & Interior Design Studio — integrated design, civil construction, interiors, and turnkey delivery across Gujarat.',
    'seo_studio_title' => 'Studio | SPANGLE Architecture & Interior Design Studio',
    'seo_work_title' => 'Work | SPANGLE Architecture & Interior Design Studio',
    'seo_journal_title' => 'Journal | SPANGLE Architecture & Interior Design Studio',
    'seo_contact_title' => 'Contact | SPANGLE Architecture & Interior Design Studio',
    'legal_privacy_html' => '<p class="section-lead">Last updated: January 2026. This policy describes how SPANGLE Architecture & Interior Design Studio and SPANGLE Architecture & Interior Design Studio (“we”) handle information when you use this website or contact us.</p><h2>Information we collect</h2><p>When you submit an enquiry through our website contact form, we collect the details you provide (such as your name, email address, phone number if given, project type if given, and message). Each submission is stored securely on our server and a notification is emailed to our studio team so we can respond. If you contact us directly by email or phone, we receive the information you choose to share.</p><h2>How we use it</h2><p>We use contact information only to respond to enquiries, prepare proposals, and manage projects. We do not sell personal data.</p><h2>Retention</h2><p>Enquiry records are kept for as long as needed to fulfil our contract and legal obligations, then deleted or anonymised according to our internal policy.</p><h2>Your rights</h2><p>Depending on applicable law, you may request access, correction, or deletion of your personal data. Contact <a href="mailto:hello@spangle.studio">hello@spangle.studio</a>.</p><h2>Changes</h2><p>We may update this page periodically. Continued use of the site after changes constitutes acceptance of the updated policy.</p>',
    'enquiry_notify_email' => 'hello@spangle.studio',
    'seo_description' => 'SPANGLE Architecture & Interior Design Studio is a premium architecture and interior design studio in Gujarat — residential, commercial, and bespoke spaces crafted with precision.',
    'legal_terms_html' => '<p class="section-lead">By using this website you agree to these terms. Content, images, and text are owned by SPANGLE Architecture & Interior Design Studio unless otherwise credited.</p><p>Information on this site is for general guidance and does not constitute a contract until agreed in writing. We reserve the right to update these terms at any time.</p>',
];
